...
object SharedPrefsHelper {
    ...
    fun saveOwnerJwtToken(context: Context, token: String?) {
        val editor = getPrefs(context).edit()
        editor.putString(KEY_OWNER_JWT_TOKEN, token)
        editor.apply()
    }
    ...
    fun getOwnerJwtToken(context: Context): String? {
        return getPrefs(context).getString(KEY_OWNER_JWT_TOKEN, null)
    }
